        ...
        <div className="newspaper__main">
          <div className="newspaper__main__article">
            ...
            <section className="newspaper__main__article__photo">
              <img
                src="https://previews.123rf.com/images/vvoennyy/vvoennyy1412/vvoennyy141200456/34833983-square-background-from-sheet-of-light-grey-color-pastel-paper-close-up.jpg"
                alt="grey square"
                align="left"
              />
            </section>
