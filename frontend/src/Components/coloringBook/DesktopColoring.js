...
const DesktopColoring = ({ fillColors, onFill }) => {
  return (
    <div>
      <svg width="256" height="256" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(128 128) scale(0.87 0.87)" display="inline">
          ...
          >
            <path
              id="svg_01"
              d="M 7.5 17.715 c 0 -0.953 0.775 -1.728 1.728 -1.728 h 71.544 c 0.953 0 1.728 0.775 1.728 1.728 v 45.372 h -75 V 17.715 z" 
              onClick={() => onFill(0)}
              fill={fillColors[0]}
              fillRule="evenodd"
              stroke="#000000"
            ...
            <path
              id="svg_02"
              d="M 45 24.549 c 7.995 0 14.5 6.505 14.5 14.5 s -6.505 14.5 -14.5 14.5 s -14.5 -6.505 -14.5 -14.5 S 37.004 24.549 45 24.549" 
              onClick={() => onFill(1)}
              fill={fillColors[1]}
              fillRule="evenodd"
              stroke="#000000"
            ...
            <path
              id="svg_03"
              d="M 88 67.931 c 0 3.342 -2.383 6.061 -5.312 6.061 H 7.311 C 4.382 73.992 2 71.273 2 67.931 v -2.009 c 0 -0.51 0.364 -0.925 0.81 -0.925 h 84.379 c 0.448 0 0.811 0.415 0.811 0.925 V 67.931 z" 
              onClick={() => onFill(2)}
              fill={fillColors[2]}
              fillRule="evenodd"
              stroke="#000000"
